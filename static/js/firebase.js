...
// GET THIS INFORMATION FROM FIREBASE WEB PROJECT SETTINGS
var firebaseConfig = {
    apiKey: "######YOUR API KEY#####",
...
db.collection('notifications').where("is_read", "==", false).onSnapshot(function (querySnapshot) {
...
db.collection('notifications').where("is_read", "==", true).onSnapshot(function (querySnapshot) {
